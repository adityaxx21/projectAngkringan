...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" id="css-main" href="{{URL::asset('css/oneui.min.css')}}">

        <!-- You can include a specific file from css/themes/ folder to alter the default color theme of the template. eg: -->
        <!-- <link rel="stylesheet" id="css-theme" href="{{URL::asset('css/themes/amethyst.min.css')}}"> -->
        <!-- END Stylesheets -->
    </head>
    <body>
        <!-- Page Container -->
        ...
        <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed">
            ...
            <aside id="side-overlay" class="font-size-sm">
                ...
                <div class="content-header border-bottom">
                    ...
                    <a class="img-link mr-1" href="javascript:void(0)">
                        <img class="img-avatar img-avatar32" src="{{URL::asset('media/avatars/avatar10.jpg')}}" alt="">
                    </a>
                    <!-- END User Avatar -->
                                    ...
                                    <div class="block-content">
                                        ...
                                        <ul class="nav-items mb-0">
                                            <li>
                                                <a class="media py-2" href="javascript:void(0)">
                                                    <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img class="img-avatar img-avatar48" src="{{URL::asset('media/avatars/avatar8.jpg')}}" alt="">
                                            ...
                                            <li>
                                                <a class="media py-2" href="javascript:void(0)">
                                                    <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img class="img-avatar img-avatar48" src="{{URL::asset('media/avatars/avatar9.jpg')}}" alt="">
                                                        <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a class="media py-2" href="javascript:void(0)">
                                                    <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img class="img-avatar img-avatar48" src="{{URL::asset('media/avatars/avatar6.jpg')}}" alt="">
                                                        <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                    </div>
                                                    <div class="media-body">
            ...
            <nav id="sidebar" aria-label="Main Navigation">
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="index.html">
                        ...
                        <span class="smini-hide">
                            <span class="font-w700 font-size-h5">Angkringan</span> <span class="font-w400">Project</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                    ...
                    <div>
                        ...
                        <div class="dropdown d-inline-block ml-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-right font-size-sm smini-hide border-0" aria-labelledby="sidebar-themes-dropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="{{URL::asset('css/themes/amethyst.min.css')}}" href="#">
                                    <span>Amethyst</span>
                                    <i class="fa fa-circle text-amethyst"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="{{URL::asset('css/themes/city.min.css')}}" href="#">
                                    <span>City</span>
                                    <i class="fa fa-circle text-city"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="{{URL::asset('css/themes/flat.min.css')}}" href="#">
                                    <span>Flat</span>
                                    <i class="fa fa-circle text-flat"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="{{URL::asset('css/themes/modern.min.css')}}" href="#">
                                    <span>Modern</span>
                                    <i class="fa fa-circle text-modern"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="{{URL::asset('css/themes/smooth.min.css')}}" href="#">
                                    <span>Smooth</span>
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-heading">Kelola Pemesanan</li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon si si-energy"></i>
                                <span class="nav-main-link-name">Kelola Menu</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon si si-energy"></i>
                                <span class="nav-main-link-name">Kelola Voucher</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon si si-energy"></i>
                                <span class="nav-main-link-name">Kelola Transaksi</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon si si-energy"></i>
                                <span class="nav-main-link-name">Laporan Transaksi</span>
                            </a>
                        </li>
                        <li class="nav-main-heading">Kelola Akun</li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon si si-energy"></i>
                                <span class="nav-main-link-name">Kelola Akun</span>
                            </a>
                        </li>
                        <li class="nav-main-heading">Kelola Pesan</li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon si si-energy"></i>
                                <span class="nav-main-link-name">Kelola Chat</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon si si-energy"></i>
                                <span class="nav-main-link-name">Kelola Komentar</span>
                            </a>
                        </li>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded" src="{{URL::asset('media/avatars/avatar10.jpg')}}" alt="Header Avatar" style="width: 18px;">
                                <span class="d-none d-sm-inline-block ml-1">Adam</span>
                                <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                                <div class="p-3 text-center bg-primary">
                                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{URL::asset('media/avatars/avatar10.jpg')}}" alt="">
                                </div>
                                <div class="p-2">
            ...
            <main id="main-container">
                ...
                <!-- Hero -->
                <div class="bg-image overflow-hidden" style="background-image: url('{{URL::asset('media/photos/photo3@2x.jpg')}}');">
                                    ...
                                    <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="{{URL::asset('media/avatars/avatar7.jpg')}}" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Amber Harvey                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="{{URL::asset('media/avatars/avatar1.jpg')}}" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Carol Ray                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="{{URL::asset('media/avatars/avatar12.jpg')}}" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Justin Hunt                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
        ...
        <!--
            ...
            {{-- {{URL::asset('js/core/jquery.min.js')}}
            {{URL::asset('js/core/bootstrap.bundle.min.js')}}
            {{URL::asset('js/core/simplebar.min.js')}}
            {{URL::asset('js/core/jquery-scrollLock.min.js')}}
            {{URL::asset('js/core/jquery.appear.min.js')}}
            {{URL::asset('js/core/js.cookie.min.js')}} --}}
        -->
        <script src="{{URL::asset('js/oneui.core.min.js')}}"></script>
        ...
        -->
        <script src="{{URL::asset('js/oneui.app.min.js')}}"></script>
